...
**Verified:** `<SNOWFLAKE_ACCOUNT>` (us-west-2 private link) — CURRENT_USER query — 2026-03.
...
1. Log in to `https://app.us-west-2.privatelink.snowflakecomputing.com/<SNOWFLAKE_ORG>/<SNOWFLAKE_ACCOUNT>`
...
- Account identifier: `<SNOWFLAKE_ACCOUNT>` (not the full URL)
